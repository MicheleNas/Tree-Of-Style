...
prompts = ["ToS", "Zero-Shot"] # Se si usa quella senza l'analisi dello stile vuol dire che si sta testando sono ToS, con il prompt normale stiamo testando la Zero-Shot
...
for model in models:
    for prompt in prompts:
        ...
        output_path = f'test/test_2/results/{model}_{prompt}_results.json'
